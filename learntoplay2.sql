...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-06-2018 a las 20:13:50
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`nick`) REFERENCES `users` (`nick`);

--
-- Filtros para la tabla `favorites`
--
ALTER TABLE `favorites`
  ADD CONSTRAINT `favorites_ibfk_1` FOREIGN KEY (`nick`) REFERENCES `users` (`nick`);

--
-- Filtros para la tabla `requests`
--
ALTER TABLE `requests`
  ADD CONSTRAINT `requests_ibfk_1` FOREIGN KEY (`nick`) REFERENCES `users` (`nick`);
COMMIT;
